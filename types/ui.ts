...
export type GameState = "LOGIN" | "LOBBY" | "MODE_SELECT" | "DECK_BUILDER" | "DUEL" | "RESULT" | "TAVERN" | "MATCHMAKING" | "DUNGEON_MAP" | "MULLIGAN" | "SHOP" | "COLLECTION" | "PROFILE" | "BATTLE_PASS" | "PVP_SYNC" | "RANKED" | "ACHIEVEMENTS" | "FRIENDS" | "ARENA" | "TAVERN_BRAWL" | "ENDLESS_TOWER" | "GUILD";
