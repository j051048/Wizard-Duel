...
const VALID_TRANSITIONS: Record<DuelPhase, DuelPhase[]> = {
  ...
  'TRIGGER_RESOLVE': ['DEATH_CHECK', 'PLAYER_TURN', 'OPPONENT_TURN', 'WAITING_FOR_OPPONENT', 'MINION_COMBAT', 'ROUND_RESET'],
  'DEATH_CHECK': ['PLAYER_TURN', 'OPPONENT_TURN', 'WAITING_FOR_OPPONENT', 'MINION_COMBAT', 'TURN_TRANSITION', 'ROUND_RESET'],
