...
describe('Combo System', () => {
  ...
  it('should identify thunder spells correctly', () => {
    expect(isThunderSpell('thunder1')).toBe(true);
    expect(isThunderSpell('thunder2')).toBe(true);
    expect(isThunderSpell('fire1')).toBe(false);
  ...
  it('should calculate combo bonus for first thunder spell', () => {
    const state = { ...mockState, playerLastSpell: 'thunder1' };
  ...
  it('should cap combo at 2 stacks', () => {
    const state = { ...mockState, playerLastSpell: 'thunder1', playerConsecutiveThunder: 2 };
    const result = calculateComboBonus(state, 'player', 'thunder2', false);
  ...
  it('should reset combo for non-thunder spells', () => {
    const state = { ...mockState, playerLastSpell: 'thunder1', playerConsecutiveThunder: 1 };
    const result = calculateComboBonus(state, 'player', 'fire1', false);
